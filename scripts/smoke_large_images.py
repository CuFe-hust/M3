"""Smoke test: process N DOTA large images with GPU memory monitoring."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output-dir", default="outputs/finetune/qwen35-9b-general-vqa-agent-lora-large-50-smoke")
    ...
    print("loaded DOTA train records:", len(train_source), flush=True)
