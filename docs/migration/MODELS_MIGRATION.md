...
| iSAID/OEM checkpoint directories | versioned metadata + Git LFS weights | Restored from `origin/try_yolo`; Git stores exact-path LFS pointers and checkout materializes verified binaries |
