...
class JudgeService:
    ...
    def __init__(
        ...
        *,
        ...
        self._cache = JsonResponseCache(cache_root)

    def _counting_client(self) -> DeepSeekJudgeClient:
        return DeepSeekJudgeClient(
            self.settings.models.deepseek,
            judge_prompt=self._judge_prompt,
            repair_prompt=self._repair_prompt,
            cache=self._cache,
        )

    def _vqa_client(self) -> DeepSeekJudgeClient:
        return DeepSeekJudgeClient(
            self.settings.models.deepseek,
            judge_prompt=self._vqa_judge_prompt,
            repair_prompt=self._repair_prompt,
            cache=self._cache,
        )
