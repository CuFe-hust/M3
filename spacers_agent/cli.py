...
def _prompts() -> dict[str, str]:
    ...
    return {
        ...
        "count_proposal": (PROJECT_ROOT / "prompts" / "general_vqa_v1.md").read_text(encoding="utf-8"),
        ...
        "change": (PROJECT_ROOT / "prompts" / "change_dual_path_v1.md").read_text(encoding="utf-8"),
        ...
        "spatial_review": (PROJECT_ROOT / "prompts" / "spatial_candidate_review_v4.md").read_text(encoding="utf-8"),
        "spatial_grid_review": (PROJECT_ROOT / "prompts" / "spatial_candidate_review_v5.md").read_text(encoding="utf-8"),
